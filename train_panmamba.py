...
device = 'cuda:0'
evaluater = Evaluate('panmamba', 'WV2', device)
model_str = 'panmamba'
satellite_str = 'WV2'
...
Model = PanMamba().to(device)
#net.load_state_dict(torch.load('/home/ubuntu/dst/pangnn/canshu/new_ourmodel/panmamba_gf2457.pth'))
#net.load_state_dict(torch.load('/home/ubuntu/dst/pangnn/canshu/model/panmamba_y_gf2135.pth'))
#net.load_state_dict(torch.load('/home/ubuntu/dst/pangnn/canshu/new_ourmodel/panmamba_wv269.pth'))
#net.load_state_dict(torch.load('/home/ubuntu/dst/pangnn/canshu/new_ourmodel/panmamba_wv375.pth'))
# net.load_state_dict(torch.load('/home/ubuntu/dst/pangnn/canshu/panmamba_wv2911.pth'))
# net.load_state_dict(torch.load('canshu/t/panmamba_wv2673.pth'))
g_optimizer = opt.Adam(Model.parameters(), lr=g_learning_rate, weight_decay=g_weight_decay)
# scheduler_1 = torch.optim.lr_scheduler.StepLR(g_optimizer, step_size=20, gamma=0.1)
