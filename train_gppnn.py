...
from model.GPPNN import *
import time


# global config
evaluater = Evaluate('GPPNN_SFAU', 'WV3', device)
model_str = 'GPPNN_SFAU'
satellite_str = 'WV3'
...
Model = GPPNN_SFAU(ms_channels,pan_channels,n_feat,n_layer).to(device)
if os.path.exists('down_results/GPPNN_SFAU/WV3_0/best_model.pth'):
    Model.load_state_dict(torch.load('down_results/GPPNN_SFAU/WV3_0/best_model.pth'))
